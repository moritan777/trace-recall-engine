...
- [Why Trace](01_why_trace.md)
- [Trace Principle](02_trace_principle.md)

## Architecture

- [Architecture Overview](architecture/trace_recall_architecture.md)
- [Activation Algorithm](architecture/activation_algorithm.md)
- [Recall Selection](05_recall_selection.md)
- [Working Memory Policy](architecture/Working_Memory_Policy.md)
- [Fatigue Control](architecture/fatigue_control.md)
...
- [Research Logger](benchmarks/Research_Log.md)
- [Evaluation Conversations](../eval_conversations/README.md)

## Concepts

- [Trace](concepts/trace.md)
- [Thread](concepts/thread.md)
- [ThreadGroup](concepts/thread_group.md)
- [Working Memory](concepts/working_memory.md)
- [Fatigue](concepts/fatigue.md)

## Design Discussions

- [Circle and Thread](discussions/circle_and_thread.md)
- [Count vs Weighted](discussions/count_vs_weighted.md)
- [Why Not Summary](discussions/why_not_summary.md)

## Project History and Roadmap

- [Design History](09_design_history.md)
