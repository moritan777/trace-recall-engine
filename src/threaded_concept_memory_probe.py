...
def evaluate_extractor_scenario(item: dict[str, Any], extractor: TraceExtractor, extractor_name: str) -> dict[str, Any]:
    ...
    return {
        ...
        **novel_diagnostics,
        ...
        "tokenizer_candidate_count": getattr(extractor, "last_diagnostics", {}).get("tokenizer_candidate_count", 0),
...
def make_parser() -> argparse.ArgumentParser:
    ...
    p_eval.add_argument("--db", default=argparse.SUPPRESS)
    p_eval.add_argument("--base-url", default=argparse.SUPPRESS)
    p_eval.add_argument("--chat-base-url", default=argparse.SUPPRESS)
    p_eval.add_argument("--api-key", default=argparse.SUPPRESS)
    p_eval.add_argument("--model", default=argparse.SUPPRESS)
    p_eval.add_argument("--extractor", choices=["llm", "fallback", "local-rule"], default=argparse.SUPPRESS)
    p_eval.add_argument("--extractor-model", default=argparse.SUPPRESS)
    p_eval.add_argument("--response-model", default=argparse.SUPPRESS)
    p_eval.add_argument("--debug-extractor", action="store_true", default=argparse.SUPPRESS)
    ...
    p_eval.add_argument("--top-threads", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--thread-strength-mode", choices=["weighted", "count"], default=argparse.SUPPRESS, help="Deprecated: eval benchmarks are count-only; weighted is coerced to count.")
    p_eval.add_argument("--common-bonus", type=float, default=argparse.SUPPRESS)
    p_eval.add_argument("--mutual-amplification", type=float, default=argparse.SUPPRESS)
    p_eval.add_argument("--response-include-trace", action="store_true", default=argparse.SUPPRESS)
    p_eval.add_argument("--response-trace-limit", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--prompt-view", choices=["threadgroup", "recall-state", "edge"], default=argparse.SUPPRESS)
    p_eval.add_argument("--origin-order", choices=["none", "group"], default=argparse.SUPPRESS)
    p_eval.add_argument("--fatigue-recent-turns", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--fatigue-threshold", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--disable-gate", action="store_true", default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-max-threads", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-max-core-words", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-max-words", type=int, default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-min-thread-score", type=float, default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-min-word-score", type=float, default=argparse.SUPPRESS)
    p_eval.add_argument("--gate-support-ratio", type=float, default=argparse.SUPPRESS)
